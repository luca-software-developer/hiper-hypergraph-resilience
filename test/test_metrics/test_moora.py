...
Unit tests for the MOORANodeRanker class.
Tests MOORA (Multi-Objective Optimization on basis of Ratio Analysis)
multi-criteria node ranking including criteria computation, ranking algorithms,
node selection, and weight handling for various hypergraph structures.
"""
...
class TestMOORANodeRanker(unittest.TestCase):
    """
    Tests MOORANodeRanker methods.
    Methods tested include node ranking computation, criteria calculation,
    top/bottom node selection, and weight customization.
    """

    def setUp(self):
        """Create MOORA ranker and test hypergraphs."""
        self.ranker = MOORANodeRanker()
    ...
    def test_moora_algorithm_components(self):
        """MOORA algorithm components should work correctly."""
        ...
        weights = [1.0, 1.0, 1.0]
        scores = self.ranker._apply_moora(criteria_matrix, weights)
