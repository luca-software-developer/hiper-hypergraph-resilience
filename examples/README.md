...
This directory contains example scripts demonstrating how to use the HIPER library for hypernetwork analysis.
...
All example scripts can work with custom datasets. To run experiments on your own hypernetwork data:

1. **Prepare your dataset**: Create a text file where each line represents a hyperedge with space-separated node IDs:
   ```
   1 2 3
   2 3 4 5
   3 4 6
...
4. **View results**: Check the corresponding results directories for plots and data files
...
These scripts are designed to be modified for your specific needs. Common modifications:
