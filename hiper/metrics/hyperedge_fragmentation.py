...
class HyperedgeFragmentationIndex:
    ...
    :math:`\\text{HFI} = 1 - \\frac{1}{|E|} \\sum_{e \\in E} \\frac{|e \\cap V'|}{|e|}`

    where:
    - E is the original set of hyperedges
    - V' is the set of nodes after perturbation
    - :math:`e \\cap V'` is the intersection of original hyperedge e with remaining nodes
    - :math:`|e|` is the original size of hyperedge e
